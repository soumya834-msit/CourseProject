...
def predict_sarcasm(new_model,s,max_length=548):
    ...
    pred*=100
    print("pred is -->",pred)
    if pred[0][0]>=70: return "It's a sarcasm!" 
...
# is_sarcasm = predict_sarcasm("@USER YOUR life must be really useless , if you have time to troll through tweets from a year ago .[ @USER : @USER America backs you . Your our next President ! ! !  Thank you !, @USER @USER 1st ) it's you're not your . And 2nd ) Trump will never be president . And 3rd ) you don't speak for America .]")

# print("is_sarcastic", is_sarcasm)
