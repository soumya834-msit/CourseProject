...
def nonDeepLearningModel(df_train,myreview):
    X = df_train['cleaned_respose']
    y = df_train['label']
    ...
    voting_clf = VotingClassifier(estimators=[('nb', text_clf_nb), ('svc', text_clf_lsvc), ('lr', text_clf_lr),('rf', text_clf_ramdomforest)],voting='hard')
